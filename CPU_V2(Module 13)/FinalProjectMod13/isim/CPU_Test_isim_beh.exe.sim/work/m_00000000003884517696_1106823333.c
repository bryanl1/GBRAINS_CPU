...
#endif
static const char *ng0 = "C:/Users/Justin/Downloads/GBRAINS_CPU/FinalProjectMod13 nowrap/FinalProjectMod13/IO_Module.v";
static int ng1[] = {0, 0};
static int ng2[] = {1, 0};
static int ng3[] = {3, 0};
static int ng4[] = {2, 0};
...
LAB19:    xsi_set_current_line(40, ng0);
    ...
    t38 = ((char*)((ng1)));
    memset(t46, 0, 8);
    xsi_vlog_unsigned_add(t46, 32, t44, 12, t38, 32);
    xsi_vlog_generic_get_array_select_value(t7, 8, t4, t11, t21, 2, 1, t46, 32, 2);
    t45 = (t0 + 2728);
    t48 = (t0 + 2728);
    t49 = (t48 + 72U);
    t50 = *((char **)t49);
    ...
    t54 = ((char*)((ng1)));
    memset(t69, 0, 8);
    xsi_vlog_unsigned_add(t69, 32, t55, 12, t54, 32);
    xsi_vlog_generic_convert_array_indices(t47, t56, t50, t53, 2, 1, t69, 32, 2);
    t57 = (t47 + 4);
    t8 = *((unsigned int *)t57);
    t30 = (!(t8));
    t60 = (t56 + 4);
...
LAB16:    t114 = (t0 + 2728);
    ...
    t123 = ((char*)((ng1)));
    memset(t125, 0, 8);
    xsi_vlog_unsigned_add(t125, 32, t124, 12, t123, 32);
    xsi_vlog_generic_convert_array_indices(t115, t116, t119, t122, 2, 1, t125, 32, 2);
    t126 = (t115 + 4);
...
LAB17:    t133 = *((unsigned int *)t115);
    t134 = *((unsigned int *)t116);
    t135 = (t133 - t134);
    t136 = (t135 + 1);
    xsi_vlogvar_wait_assign_value(t114, t45, 24, *((unsigned int *)t116), t136, 0LL);
    goto LAB18;

LAB20:    t10 = *((unsigned int *)t47);
    t13 = *((unsigned int *)t56);
    t62 = (t10 - t13);
    t63 = (t62 + 1);
    xsi_vlogvar_assign_value(t45, t7, 0, *((unsigned int *)t56), t63);
    goto LAB21;

LAB22:    t10 = *((unsigned int *)t47);
    t13 = *((unsigned int *)t56);
    t62 = (t10 - t13);
    t63 = (t62 + 1);
    xsi_vlogvar_assign_value(t45, t7, 0, *((unsigned int *)t56), t63);
...
LAB11:    t50 = (t0 + 2728);
    ...
    t99 = ((char*)((ng1)));
    memset(t101, 0, 8);
    xsi_vlog_unsigned_add(t101, 32, t100, 12, t99, 32);
    xsi_vlog_generic_get_array_select_value(t92, 8, t91, t95, t98, 2, 1, t101, 32, 2);
...
LAB15:    xsi_vlog_unsigned_bit_combine(t3, 32, t49, 32, t106, 32);
    goto LAB19;
...
extern void work_m_00000000003884517696_1106823333_init()
{
	static char *pe[] = {(void *)Initial_25_0,(void *)Always_32_1,(void *)Cont_47_2};
	xsi_register_didat("work_m_00000000003884517696_1106823333", "isim/CPU_Test_isim_beh.exe.sim/work/m_00000000003884517696_1106823333.didat");
